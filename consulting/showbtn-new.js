const s = [
	  ...
	  url = [
  	  ...
  	  d = new Date().toLocaleDateString('eu-EU',{timeZone: "Europe/Moscow"}).split('.').reverse().join('-'),
}
	htmlStyle = `
			#forButton {
				position: absolute;
...
fetch(new Request(`https://api.yclients.com/api/v1/activity/85062/history_search/?from=${my.d}&till=${my.d}`, {
					headers: {
