...
const services = ["4406660", "4406662", "4406663", "4406661"],
  ...
  htmlBtn = `
    <div style="position: absolute;z-index: 1;margin-left: 215px;margin-top: 45px;margin-top: 46px;idth: 133px;height: 22px;display:flex;justify-content: space-between;"><button id="button" style="background: red;border: 1px solid red;border-radius: 4px;font-family: 'GraphikLLCT',Arial,sans-serif;color: white;font-weight: bold;text-align: left;" class="">В ЭФИРЕ</button></div>`;
